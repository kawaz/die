...
- [DR-0008-stdin-tty-routing-and-help-option](./DR-0008-stdin-tty-routing-and-help-option.md) — stdin routing は TTY 判定軸 (`GetConsoleMode` + Cygwin pty 名前判定)、`--help` option 導入 (refines DR-0001)
